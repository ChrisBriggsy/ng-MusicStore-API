...
namespace ng_MusicStore_Models
{
	public class SampleData
	{
		...
		public SampleData(IDbContextFactory<MusicStoreContext> dbContextFactory)
		{
		...
		public async Task InitializeMusicStoreDatabaseAsync()
		{
		...
		private async Task InsertTestData()
		{
			...
			await AddOrUpdateAsync(g => g.GenreId, Genres.Select(genre => genre.Value));
			await AddOrUpdateAsync(a => a.ArtistId, Artists.Select(artist => artist.Value));
